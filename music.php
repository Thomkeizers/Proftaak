                ...
                <div class="content">      
                    ...
                    <?php foreach ($bandsinfo1 as $bandinfo1)
                        ...
                        <img src="img/<?php echo $bandinfo1['bandImg'];?>" alt="" class="content__img">
                            ...
                            <h3 class="content__albumtitle"><?php echo $bandinfo1['bandName']; ?></h3>
                        </div>  
                        <?php
                            }
                            ?>        
                    ...
                    <?php foreach ($bandsinfo2 as $bandinfo2)
                            ...
                            ?>
                    <div class="content__album">
                    <img src="img/<?php echo $bandinfo2['bandImg'];?>" alt="Avatar" style="width:300px;height:300px;" class="content__img">                      
                            <a href="playlist.php?bandID=<?php echo $bandinfo2['bandID']; ?>" class="content__todetail">To playlist</a>
                            <h3 class="content__albumtitle"><?php echo $bandinfo2['bandName']; ?></h3>
                        </div>
                        <?php
                            }
                            ?>
